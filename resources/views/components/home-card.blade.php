...
<a class="flex-1 border border-slate-200 rounded-lg px-6 pt-32 pb-4 inline-flex justify-between group hover:bg-gradient-to-br from-dodger-blue to-wisteria hover:text-white hover:shadow-outline transition-['box-shadow'] duration-250"
    href="/{{$url}}">
